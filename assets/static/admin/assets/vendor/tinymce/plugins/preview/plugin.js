...
(function () {
    ...
    const getPreviewHtml = editor => {
      ...
      const previewHtml = '{% load static %}
<!DOCTYPE html>' + '<html>' + '<head>' + headHtml + '</head>' + '<body id="' + encode(bodyId) + '" class="mce-content-body ' + encode(bodyClass) + '"' + dirAttr + '>' + editor.getContent() + preventClicksOnLinksScript + '</body>' + '<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
