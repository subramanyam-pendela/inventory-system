...
(function () {
    ...
    const getPreviewContent = (editor, html) => {
      ...
      if (html.indexOf('<html>') === -1) {
        ...
        previewHtml = '{% load static %}
<!DOCTYPE html>' + '<html>' + '<head>' + '<base href="' + encode(editor.documentBaseURI.getURI()) + '">' + contentCssEntries + preventClicksOnLinksScript + '</head>' + '<body class="' + encode(bodyClass) + '"' + dirAttr + '>' + previewHtml + '</body>' + '<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
